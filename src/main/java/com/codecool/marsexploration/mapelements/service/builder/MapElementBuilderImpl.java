...
public class MapElementBuilderImpl implements MapElementBuilder{
    ...
    //MapElementConfiguration List of new ElementToSize(2, size:20), MapConfiguration.getConfiguration().mountainSymbol
    //MapElementConfiguration.dimensionGrowth, MapElementConfiguration.preferredLocationSymbol
}
